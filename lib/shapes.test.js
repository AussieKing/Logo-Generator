...
const {Circle, Triangle, Square, Diamond} = require('./shapes.js');
...
describe('Triangle', () => {
    test('should return a triangle with a color', () => {
        ...
        let color = 'blue';
        shape.setColor(color);
        expect(shape.render()).toEqual('<polygon points="150,18 75,180 225,180" fill="red" />');
    });
});
...
describe('Square', () => {
    test('should return a square with a color', () => {
        ...
        let color = 'green';
        shape.setColor(color);
        expect(shape.render()).toEqual('<rect x="18" y="18" width="264" height="164" fill="red" />');
    });
});
...
describe('Diamond', () => {
    test('should return a diamond with a color', () => {
        ...
        let color = 'yellow';
        shape.setColor(color);
        expect(shape.render()).toEqual('<polygon points="150,18 75,100 150,180 225,100" fill="red" />');
    });
});
